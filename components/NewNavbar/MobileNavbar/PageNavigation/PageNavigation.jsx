...
const PageNavigation = ({ showMobPagesNav, setShowMobPagesNav, loginUser, userPosition }) => {
		...
		<div className={`${styles.page_navigation_container} page-navigation-container modal-bg transition ${showMobPagesNav ? 'show-bd' : 'hide-bd'}`}>
			<div className={`${styles.page_navigation_wrapper} page-navigation-wrapper white-bg sidebar transition ${showMobPagesNav && 'show-sidebar'}`}>
				...
				<ul>
					...
					<li className={router?.pathname === '/sponsored-program' ? styles.active_mob_nav : undefined}>
						{router?.pathname !== '/sponsored-program' ? (
							<Link href='/sponsored-program'>
								<a onClick={() => setShowMobPagesNav(false)}> Sponsored Program </a>
							</Link>
						) : (
							<a> Sponsored Program </a>
						)}
					</li>
					...
					<li className={`${router?.pathname === '/get-pet-badges' ? styles.active_mob_nav : undefined}`}>
					...
					<li className={router?.pathname === '/vet-rep-finder' ? styles.active_mob_nav : undefined}>
						{router?.pathname !== '/vet-rep-finder' ? (
							<Link href='/vet-rep-finder'>
								<a onClick={() => setShowMobPagesNav(false)}>VetRep Finder</a>
							</Link>
						) : (
							<a> VetRep Finder </a>
						)}
